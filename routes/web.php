...
Route::get('/agents/{username}', 'PagesController@agentshow')->name('agents.show');
...
Route::group(['prefix'=>'agent','namespace'=>'Agent','middleware'=>['auth','agent','verified'],'as'=>'agent.'], function(){
...
Route::group(['prefix'=>'user','namespace'=>'User','middleware'=>['auth','user','verified'],'as'=>'user.'], function(){
