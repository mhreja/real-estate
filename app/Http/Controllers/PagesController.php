...
class PagesController extends Controller
{
    ...
    public function propertieshow($slug)
    {
        ...
        $this->setPageTitle($property->title);
    ...
    public function agents()
    {
        ...
        $this->setPageTitle('Property Agents');
    ...
    public function agentshow($username)
    {
        ...
        if(empty($agent)) abort(404);
        $properties = Property::latest()->where('agent_id', $agent->id)->paginate(10);

        $this->setPageTitle(ucfirst($agent->name) . ' | Property Agents');
    ...
    public function blogshow($slug)
    {
        ...
        $this->setPageTitle(ucfirst($post->title));
    ...
    public function propertyCities()
    {
        ...
        $this->setPageTitle('Properties in ' . ucfirst(request('cityslug')));
        return view('pages.properties.property', compact('properties','cities'));
    }
