                            ...
                            <ul class="collection with-header m-t-0">
                                        ...
                                        <div class="card horizontal card-no-shadow">
                                            ...
                                            <div class="card-stacked">
                                                <div class="p-l-10 p-r-10">
                                                    ...
                                                    /
                                                    <strong>{{ $property->user->phone_no }}</strong>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="p-l-10 p-r-10">
                                            <p>{{ $property->user->about }}</p>
                                            <a href="{{ route('agents.show',$property->user->username) }}" class="profile-link">View Profile</a>
                                        </div>
                                    @endif
                                </li>
                                ...
                                <li class="collection agent-message">
                                    <form class="agent-message-box" action="" method="POST">
                                        ...
                                        <div class="box">
                                            <input type="text" name="phone" placeholder="Your Phone" maxlength="10">
                                        </div>
                                        <div class="box">
