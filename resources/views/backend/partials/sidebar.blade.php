    <aside id="leftsidebar" class="sidebar">
        ...
        <div class="menu">
            <ul class="list">
                ...
                <li class="header" style="background-color: #3F51B5; color: white;">MAIN NAVIGATION</li>
                ...
                <li class="header" style="background-color: #3F51B5; color: white;">Blog</li>
                ...
                <li class="header" style="background-color: #3F51B5; color: white;">Credentials</li>
